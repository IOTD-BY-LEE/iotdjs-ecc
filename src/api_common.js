...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // IOTDKey...
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'IOTD') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like IOTDKey..
        @arg {string} [pubkey_prefix = 'IOTD']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'IOTD') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (IOTDbase58sig.., Hex, Buffer)
